function recording_newton_method()
    ...
    loglog(e_n_new, e_n1_new, 'b.', 'MarkerSize', 20, 'DisplayName', "Newton's Method Filtered Error");
    
    % generating and plotting the fit line
    [p, k] = generate_error_fit(e_n_new, e_n1_new);
    fit_line_x = 10.^(-8:.01:2);
    ...
    exportgraphics(myfig , 'NEWTON_METHOD_CONVERGENCE_NEW.png', 'Resolution', 600); %saves plot to plot_name at high resolution
