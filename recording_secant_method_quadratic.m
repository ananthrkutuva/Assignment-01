% function recording_secant_method_quadratic()
...
function recording_secant_method_quadratic()
    ...
    num_iter = 1000;
    x0_list = linspace(0, 35, num_iter);
    x1_list = linspace(38, 60, num_iter);
    ...
    for n = 1:num_iter
        ...
        % runs the solver
        [~, ~, x_list] = secant_solver_rec(@test_function02, x0, x1, dxtol, ftol, max_iter, dxmax);
