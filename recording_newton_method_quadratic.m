function recording_newton_method_quadratic()
    close all;
    ...
    f_record = my_recorder.generate_recorder_fun(@test_function02);
    ...
    x0_list = linspace(0,60,num_iter);
